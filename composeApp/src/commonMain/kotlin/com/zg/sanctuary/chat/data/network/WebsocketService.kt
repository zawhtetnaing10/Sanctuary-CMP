...
class WebsocketService {
    ...
    suspend fun connect(host: String = BASE_IP, port: Int = SOCKET_PORT, accessToken: String, conversationId: Int) {
        ...
        try {
            // Listen to messages
            HttpClientProvider.httpClient.webSocket(method = HttpMethod.Get, host = host, port = port, path = "/ws?conversation_id=$conversationId", request = {
